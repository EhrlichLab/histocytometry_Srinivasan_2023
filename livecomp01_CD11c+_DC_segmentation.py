...
if __name__ == "__main__":
    ...
    CD11c_cortex_dirs = [os.path.join(raw_dir, img_dir) for img_dir in os.listdir(raw_dir) if re.search("_[A-D]$", img_dir) and not re.search("Sirpa_C$", img_dir) and re.search("cortex", img_dir)]
        ## and not re.search("MerTK", img_dir)
        ## I'm throwing in MerTK to see how they look.
    CD11c_cortex_dirs.sort()
    CD11c_cortex_dirs = CD11c_cortex_dirs[11:21]
