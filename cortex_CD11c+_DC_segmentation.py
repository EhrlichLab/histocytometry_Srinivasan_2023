...
if __name__ == "__main__":
    ...
    img_dirs = [os.path.join(raw_dir, img_dir) for img_dir in os.listdir(raw_dir) if re.search("_[A-D]$", img_dir) and not re.search("Sirpa_C$", img_dir) and not re.search("SiglecH_B|CD207_CD11c_XCR1_C", img_dir)]
        ## Not running SiglecH_B nor CD207_CD11c_XCR1_C for now
    img_dirs.sort()
    ...
    ## Segment DCs 
    for img_dir in CD11c_cortex_dirs:
        print(img_dir)
